...
import com.dicoding.storyviewapp.DataDummy
import com.dicoding.storyviewapp.MainDispatcherRule
...
import com.dicoding.storyviewapp.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        val storyDummy = DataDummy.generateDummyListStoryResponse()
        val data: PagingData<ListStoryItem> = StoryPagingSource.snapshot(storyDummy)
        val expectedStory = MutableLiveData<PagingData<ListStoryItem>>()
        expectedStory.value = data
        Mockito.`when`(userRepository.listStory()).thenReturn(expectedStory)
